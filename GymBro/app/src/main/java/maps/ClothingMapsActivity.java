...
import com.example.gymbro.databinding.ActivityClothingMapsBinding;
...
public class ClothingMapsActivity extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private ActivityClothingMapsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityClothingMapsBinding.inflate(getLayoutInflater());
                    ...
                    .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                        ...
                        public void onSuccess(Location location) {
                            ...
                            if (location != null) {
                                ...
                                RequestQueue queue = Volley.newRequestQueue(ClothingMapsActivity.this);
