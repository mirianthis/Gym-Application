...
import com.example.gymbro.databinding.ActivityGymMapsBinding;
                    ...
                    .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                        ...
                        public void onSuccess(Location location) {
                            ...
                            if (location != null) {
                                ...
                                // Set up Places API
                                Places.initialize(getApplicationContext(), "Google Maps Key");
                                PlacesClient placesClient = Places.createClient(GymMapsActivity.this);
                                ...
                                RequestQueue queue = Volley.newRequestQueue(GymMapsActivity.this);
